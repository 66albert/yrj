...
/**
 * @author ：刘彬
 * @date ：Created in 2023/2/26 22:27
 * @description：请求乱码解决
 *                  乱码原因
 ...
 *                  解决方案
 *                      POST请求
 *                          无论是什么版本的服务器都会出现乱码，需要通过request.setCharacterEncoding("UTF-8")设置编码格式。（只针对POST请求有效）
 *                      GET请求
